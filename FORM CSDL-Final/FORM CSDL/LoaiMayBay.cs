...
namespace FORM_CSDL
{
    public partial class LoaiMayBay : Form
    {
        public LoaiMayBay()
        {
            InitializeComponent();
        ...
        private void LoaiMayBay_Load(object sender, EventArgs e)
        {
            // Khởi động kết nối
            conn = new SqlConnection(strConnectionString);
            // Vận chuyển dữ liệu lên DataTable dtTABLENAME
            daTABLENAME = new SqlDataAdapter("Select * from LOAIMAYBAY", conn);
        ...
        void hien_thi()
        {
            ...
            this.textBox_MaLoaiMayBay.Text = dataGridView1.Rows[r].Cells[0].Value.ToString();
            this.textBox_HangSX.Text = dataGridView1.Rows[r].Cells[1].Value.ToString();
        ...
        private void button_Xoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                hien_thi();
                // Viết câu lệnh SQL
                cmd.CommandText = System.String.Concat($"EXEC DELETE_LOAIMAYBAY '{this.textBox_MaLoaiMayBay.Text}'");
                cmd.CommandType = CommandType.Text;
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Viết câu lệnh SQL
                cmd.CommandText =
                System.String.Concat($"EXEC INSERT_LOAIMAYBAY '{this.textBox_MaLoaiMayBay.Text}','{this.textBox_HangSX.Text}'");
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText =
               System.String.Concat($"EXEC UPDATE_LOAIMAYBAY '{this.textBox_MaLoaiMayBay.Text}','{this.textBox_HangSX.Text}'");
